...
def reference_genome_view(request, project_uid, ref_genome_uid):
    ...
    context = {
        ...
        'has_fasta': reference_genome.dataset_set.filter(type=Dataset.TYPE.REFERENCE_GENOME_FASTA).exists(),
        'has_genbank': reference_genome.dataset_set.filter(type=Dataset.TYPE.REFERENCE_GENOME_GENBANK).exists(),
